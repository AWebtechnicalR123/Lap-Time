$(function(){
    ...
    function updateTime(){
        //1min = 60*100sec centiseconds
        timeMinutes = Math.floor(timeCounter/6000);
        //1sec=100centiseconjds
        timeSeconds = Math.floor((timeCounter%6000)/100);
        timeCentiseconds = (timeCounter%6000)%100;
        $("#timeminute").text(format(timeMinutes));
        $("#timesecond").text(format(timeSeconds)); $("#timecentisecond").text(format(timeCentiseconds));
...
//        $(myLapDetails).appendTo("#laps");
        $(myLapDetails).prependTo("#laps");//last lap is apprearing to top
    }
});